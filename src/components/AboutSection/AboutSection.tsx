  ...
  return (
    <section id="about">
      ...
      <p>
        ...
        Philippines. I specialize in Web Development and enjoy the challenge in
        taking on project requirements and complex designs and implementing them
        into simple and beautiful systems for clients and customers while doing
        it in the most elegant and efficient way I am capable of for other
        developers.
      </p>
      <p>
